...
void main() {
  imgMsg(text: "this i stext ",url :"google.com").tostring();
}

class msg {
  late String msg1 ; 
  msg();
  msg.pass({required String a}){
    msg1 = a;
  }
}

class imgMsg extends msg {
  late String url ;
  imgMsg({required String text , required String url}) :super.pass(a:text){
    //super.pass(text);
    this.url = url;
  }
  void tostring(){
